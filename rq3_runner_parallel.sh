...
export EXPL_PATH SAVEDIR MODEL

process_bug() {
    local bugname=$1
    local bug_savedir="$SAVEDIR/$bugname"
...
parallel -j16 --bar process_bug :::: "$BUG_LIST_FILE"

python organize_results.py --expr_dir $SAVEDIR
/home/sungmin/miniconda3/envs/auto-code-rover/bin/python patch_runner.py -d $SAVEDIR --run_id $EXPR_NAME --workers 8
/home/sungmin/miniconda3/envs/auto-code-rover/bin/python patch_runner.py -d $SAVEDIR --run_id $EXPR_NAME --workers 8
